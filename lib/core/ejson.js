...
EJSON.addType('Astronomy1', function(json) {
  let Class = AstroClass.get(json.class);
  console.log('Astronomy --------new');
  ...
  if (!Class) {
    console.warn(
      `[Astronomy] a document of class ${json.class} arrived before class was initialized`,
    );
